...
func (pub *publicTransactionPool) GetTransactionByBlockHashAndIndex(ctx context.Context, blockHash common.Hash, index hexutil.Uint) (*RPCTransaction, error) {
	var r *RPCTransaction
	err := pub.client.CallContext(ctx, &r, "eth_getTransactionByBlockHashAndIndex", blockHash, index)
	if err != nil {
		return nil, err
	}
	return r, nil
...
type PublicFilter interface {
	...
	NewFilter(ctx context.Context, crit filters.FilterCriteria) (ethrpc.ID, error)
	...
	UninstallFilter(ctx context.Context, id ethrpc.ID) (bool, error)

	// GetFilterLogs returns the logs for the filter with the given id.
	// If the filter could not be found an empty array of logs is returned.
	//
	// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getfilterlogs
	GetFilterLogs(ctx context.Context, id ethrpc.ID) ([]*types.Log, error)
	...
	GetFilterChanges(ctx context.Context, id ethrpc.ID) (interface{}, error)
}
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_newfilter
func (pub *publicFilter) NewFilter(ctx context.Context, crit filters.FilterCriteria) (ethrpc.ID, error) {
	var r ethrpc.ID
	err := pub.client.CallContext(ctx, &r, "eth_newFilter")
	if err != nil {
		return r, err
	}
	return r, nil
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getlogs
func (pub *publicFilter) GetLogs(ctx context.Context, crit filters.FilterCriteria) ([]*types.Log, error) {
	var r []*types.Log
	err := pub.client.CallContext(ctx, &r, "eth_getLogs")
	if err != nil {
		return r, err
	}
	return r, nil
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_uninstallfilter
func (pub *publicFilter) UninstallFilter(ctx context.Context, id ethrpc.ID) (bool, error) {
	var r bool
	err := pub.client.CallContext(ctx, &r, "eth_uninstallFilter")
	if err != nil {
		return r, err
	}
	return r, nil
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getfilterlogs
func (pub *publicFilter) GetFilterLogs(ctx context.Context, id ethrpc.ID) ([]*types.Log, error) {
	var r []*types.Log
	err := pub.client.CallContext(ctx, &r, "eth_getFilterLogs")
	if err != nil {
		return r, err
	}
	return r, nil
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getfilterchanges
func (pub *publicFilter) GetFilterChanges(ctx context.Context, id ethrpc.ID) (interface{}, error) {
	var r interface{}
	err := pub.client.CallContext(ctx, &r, "eth_getFilterChanges")
	if err != nil {
		return r, err
	}
	return r, nil
